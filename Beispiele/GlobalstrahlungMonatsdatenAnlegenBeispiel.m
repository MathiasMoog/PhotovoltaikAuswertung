...
% In diesem Beispiel wird eine neue Zeitreihe angelegt.
...
monatsdaten = GlobalstrahlungMonatsdaten([3597369,5449839])

% Den vorletzten Monat ermitteln - sonst wird zu viel geladen ...
heute = clock()
[jahr, monat] = monatsdaten.previous_month(heute(1),heute(2))
[jahr, monat] = monatsdaten.previous_month(jahr, monat)

% Eine neue Zeitreihe (Monatsdaten) anlegen
monatsdaten.create( jahr, monat, "", true )
% Wenn alles gut geht, dann wurden ein oder zwei Monate heruntergeladen

% Daten speichern
monatsdaten.save("GlobMonBspFeu.csv")
